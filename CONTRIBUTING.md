...
- **Local workspace rule:** Use a single local Milady repo folder and switch branches in place. Do not create extra clone/worktree folders (`milady-*`) unless explicitly required for a one-off recovery/debug task.
